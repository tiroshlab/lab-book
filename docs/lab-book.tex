...
\setlength{\droptitle}{-2em}
  ...
  \postdate{\par}
    \date{Last updated on 2019-11-14}
...
\tightlist
\item
  \href{https://www.dropbox.com/home/Tirosh\%20Lab}{Lab Dropbox}\\
\item
  \href{https://www.github.com/tiroshlab}{Lab GitHub (tiroshlab)}\\
\item
...
\item
  \href{https://www.dropbox.com/sh/javjoi26i5k5f6t/AADAX4RgSZUFuBwtS6TRE3wua?dl=0}{Lab
...
\item
  ...
  Members}\\
\item
  \href{http://www.weizmann.ac.il/mcb/tirosh/pictures}{Lab Pictures :)}
\end{itemize}
...
\subsection{Writing in rmarkdown}\label{writing-in-rmarkdown}

The book is written in rmarkdown (file extension Rmd). There is one Rmd
file per chapter, so when you click the edit icon you are opening the
file chapterX.Rmd. Writing in a Rmd file is similar to writing in a
normal text document but with some required syntax to bear in mind,
namely for: + New lines + New paragraphs + Sections, subsections,
subsubsections etc + List items (bulleted or numbered)

\href{https://rstudio.com/wp-content/uploads/2015/03/rmarkdown-reference.pdf}{This
1-page cheatsheet} covers all of the basics and
\href{https://bookdown.org/yihui/rmarkdown}{this book on (publishing
with) rmarkdown} is a useful guide for those interested in finding out
more.
