...
Note that with both options below, you will have to wait a few minutes
for your edits to appear on the website. This is because the lab book
needs to be re-built after any changes are made.
...
\item
  ...
  \tightlist
  \item
    E.g. \href{https://jlaffy.github.io/lab-book/contact.html}{Chapter 3
...
\item
  ...
  \item
    ...
    \texttt{git\ clone\ https://github.com/jlaffy/lab-book.git}\\
  \end{itemize}
\item
...
The default book is a \href{https://jlaffy.github.io/lab-book}{website}.
You can also choose to download the book as PDF or ebook. To do this,
click the download icon at the top of the website page.
